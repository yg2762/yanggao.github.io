...
### Chart A:Boxplot demonstrating distribution of scores of Korean Restaurant in Manhattan among streets
...
### Chart B Bar plot showing restaurant numbers among boro
```{r}
inspec_df %>% 
  group_by (boro) %>% 
  summarise(count = n()) %>% 
