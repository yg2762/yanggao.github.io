...
### Chart A Bar plot showing restaurant numbers among boros
...
### Chart B Boxplot demonstrating distribution of scores of Korean Restaurant in Manhattan among streets
...
### Chart C Mean score of cuisines in Manhattan
...
inspec_df %>% 
  ...
  plot_ly(
    x = ~cuisine_description, y = ~mean_score, type = "scatter")
```
